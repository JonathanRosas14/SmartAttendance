...
export default function HistorialView({ usuario, menuVisible, setMenuVisible, onLogout, onSettings }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <Text style={styles.titulo}>Tu asistencia</Text>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.card}>
                ...
                <Text style={[styles.cardEstado, item.asistio === false && styles.cardEstadoFalta]}>
                  {item.asistio === false ? "No asistió" : "Asistió"}
                </Text>
              </View>
            )}
            scrollEnabled={false}
