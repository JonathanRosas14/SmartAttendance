...
function detectarSuplantacion(asistencias, estudiantes) {
  ...
  asistencias.forEach(asistencia => {
    if (asistencia.asistio === false || !asistencia.mac_address) return;
    ...
    return (
      ...
      >
        <View style={styles.sesionInfo}>
          ...
          {esSeleccionada && (
            <Text style={styles.sesionSeleccionadaText}>Lista para exportar</Text>
          )}
        </View>
        <View style={styles.sesionBadge}>
          <Text style={styles.sesionTotal}>{item.total}</Text>
          <Text style={styles.sesionLabel}>registros</Text>
        </View>
        {esSeleccionada && (
